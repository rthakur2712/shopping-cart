        ...
        <div  >
            {
                    ...
                    <div className="w-[100%] md:w-[40%] mt-5  flex flex-col" >
                        <div className="flex flex-col p-5 gap-5 my-14  h-[100%] justify-between">
                            ...
                            <div className="flex flex-col">
                                <p className="text-xl font-semibold text-gray-700">Total Amount :<span className=" font-bold text-black"> ${totalAmount}</span></p>
                ...
                (<div className="min-h-[80vh] flex flex-col items-center justify-center">
                    ...
                    <Link to="/"><button className="bg-green-600 hover:bg-purple-50 rounded-lg text-white transition duration-300 ease-linear mt-5 border-2 border-green-600 font-semibold hover:text-green-700 p-3 px-10 tracking-wider">Shop Now</button> </Link> 
                    </div>)
            }
        </div>
    )
